...
@Component({
  ...
  templateUrl: './thethao.page.html',
  styleUrls: ['./thethao.page.scss'],
})
export class ThethaoPage implements OnInit {
  ...
  async loadCamXucTuVung() {
    this.boThuList = await this.firebaseService.getTheThaoTuVung();
    if (this.boThuList) {
